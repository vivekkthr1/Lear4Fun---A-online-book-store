...
<nav class="navbar navbar-expand-sm navbar-dark bg-dark fixed-top">
  ...
  <section id="staff" class="text-center bg-dark text-white">
    <div class="container">
    <h3 style="font-family: cursive;">Crafted by </h3>
      <div class="row">
        <div class="col-md-12">
          <img src="../img/person1.jpg" alt="" class="img-fluid rounded-circle" style="height: 150px;width: 150px;">
          <h4>Vivek kothari</h4>
        </div>
       </div>
    </div>
