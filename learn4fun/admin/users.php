...
<div id="mySidenav" class="sidenav">
 ...
 <div class="p-3">
     <?php
        ...
        echo '<div class="card">
        <div class="card-body d-flex flex-row"><h1>'.$i.'.&nbsp;</h1><h3 class="bg-primary text-white p-2"><i>'.$user_firstname.' '.$user_lastname.'</i></h3>&nbsp;&nbsp;'.$user_username.'&nbsp;&nbsp;'.$user_email.'
        <form action="deleteuser.php" method=post>
        <button class="btn btn-danger btn-sm m-2" type="submit" name="deleteuser" value="'.$user_id.'">Delete User</button>&nbsp;&nbsp;
        </form>
      </div> 
    </div>';
        }
